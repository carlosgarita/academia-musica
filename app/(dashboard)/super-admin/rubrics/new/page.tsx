...
export default function NewRubricPage() {
  ...
  return (
    <div className="max-w-xl space-y-6">
      <div>
        <h1 className="text-xl font-semibold text-gray-900">Nueva Rúbrica</h1>
        <p className="text-sm text-gray-500">Crear rúbrica en el catálogo global</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-4 bg-white p-6 rounded-lg shadow">
        ...
        <div>
          ...
          <input
            ...
            placeholder="Ej: Digitación, Coordinación"
