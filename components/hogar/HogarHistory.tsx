  ...
  if (historicalCourses.length === 0) {
    return (
      <div className="text-center py-8">
        ...
        <p className="text-gray-500">No hay historial académico anterior.</p>
      </div>
    );
  }
    ...
    <div className="space-y-6">
      ...
      <section>
        ...
        {loadingBadges ? (
          ...
          <p className="text-gray-500 text-sm">No hay insignias ganadas.</p>
        ) : (
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3">
            {badges.map((badge, idx) => (
              ...
              >
                ...
                <p className="text-xs text-gray-500 mt-1">{badge.courseName}</p>
              </div>
            ))}
          </div>
        )}
